...
function SingleProduct() {
  ...
  if (filterProduct.length!=0) console.log(typeof filterProduct[0].images.length);
  if (filterProduct.length!=0) {
    return (
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if(!activity){dispatch(
                    addedid(filterProduct[0].id)
                  );
                  dispatch(
                    addCart([filterProduct[0], { quantityid: Number(quantity) }])
                  );}
                  navigate('/cart')
                }}
              >
